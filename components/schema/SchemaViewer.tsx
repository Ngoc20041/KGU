...
export default function SchemaViewer() {
    ...
    return (
        <div className="flex h-full bg-gray-50 dark:bg-zinc-900 border-r border-gray-200 dark:border-zinc-800 rounded-lg overflow-hidden shadow-sm">
            ...
            <div className="flex-1 flex flex-col bg-white dark:bg-zinc-900 overflow-hidden">
                {selectedTable ? (
                    <>
                        {/* Header */}
                        <div className="px-6 py-4 border-b border-gray-200 dark:border-zinc-800 flex justify-between items-start bg-white dark:bg-zinc-900">
                            <div>
                        ...
                        <div className="px-6 border-b border-gray-200 dark:border-zinc-800 bg-gray-50/50 dark:bg-black/20">
                            <div className="flex gap-6">
                                <button className="py-3 text-sm font-medium border-b-2 border-emerald-500 text-emerald-700 dark:text-emerald-400">
                                    Columns
                                </button>
                                <button className="py-3 text-sm font-medium border-b-2 border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400">
                                    Policies
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 overflow-auto">
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-gray-50 dark:bg-zinc-800/50 sticky top-0 z-10">
                                    <tr>
                                        <th className="px-6 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-zinc-800">
                                            Name
                                        </th>
                                        <th className="px-6 py-3 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider border-b border-gray-200 dark:border-zinc-800">
                                            Description
                                ...
                                <tbody className="divide-y divide-gray-100 dark:divide-zinc-800">
                                    {selectedTable.columns.map((col, idx) => (
                                        <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-zinc-800/50 group">
                                            <td className="px-6 py-3 border-b border-gray-100 dark:border-zinc-800/50">
                                            ...
                                            <td className="px-6 py-3 text-sm text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-zinc-800/50">
                                                {col.foreignKey && (
                                            ...
                                            <td className="px-6 py-3 text-sm text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-zinc-800/50 font-mono text-xs">
                                                {col.format}
                                            </td>
                                        </tr>
                                    ))}
