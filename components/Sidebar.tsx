    ...
    return (
      ...
      `}>
                <div className="h-full px-3 py-4 overflow-y-auto">
                    ...
                    `}
                                    >
                                        <Icon className={`w-5 h-5 transition duration-75 ${isActive ? 'text-indigo-600' : 'text-gray-500 group-hover:text-gray-900'}`} />
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 border-t border-gray-200">
                        <button className="flex items-center w-full p-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
